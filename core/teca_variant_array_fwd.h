...
using const_p_teca_short_array = std::shared_ptr<teca_variant_array_impl<short>>;
...
using const_p_teca_unsigned_short_array = std::shared_ptr<teca_variant_array_impl<unsigned short>>;
