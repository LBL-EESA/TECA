...
class teca_threaded_algorithm(teca_algorithm):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["New"] = lambda x: _teca_py_core.teca_threaded_algorithm_New
    if _newclass:
        New = staticmethod(_teca_py_core.teca_threaded_algorithm_New)
...
teca_threaded_algorithm_New = _teca_py_core.teca_threaded_algorithm_New
