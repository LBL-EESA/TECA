...
int main(int argc, char **argv)
{
    ...
    mesh->append_field_generator({"q",
        teca_array_attributes(teca_variant_array_code<double>::get(),
            ...
            teca_array_attributes::xyzt_active(), "g kg^-1", "specific humidty",
            "test data where q = sin(p)", 1, fill_value),
            q});
    ...
    mesh->append_field_generator({"u",
        teca_array_attributes(teca_variant_array_code<double>::get(),
            ...
            "test data where u = cos(p)", 1, fill_value),
            u});
    ...
    mesh->append_field_generator({"v",
        teca_array_attributes(teca_variant_array_code<double>::get(),
            ...
            "test data where v = p", 1, fill_value),
            v});
