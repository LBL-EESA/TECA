...
int gfdl_tc_candidates_c ## _c_name ## _v ## _v_name ( \
     ...
     const _v_type *Gvort, const _v_type *Gtbar, const _v_type *Gpsl, \
     const _v_type *Gthick, const _c_type *Grlat, const _c_type *Grlon, \
     long *Gnlat, long *Gnlon, int *frprm_itmax, long *step, int *count, \
     void *atable); \
\
namespace { \
int gfdl_tc_candidates( \
     ...
     long step, int &count, void *atable) \
{ \
    return gfdl_tc_candidates_c ## _c_name ## _v ## _v_name ( \
        ...
        &Gnlon, &frprm_itmax, &step, &count, atable); \
} \
};
