...
\noindent Note that we explicitly set gcc 5 compilers, as the default compilers on Ubuntu 14.04 
are missing some C++11 features. On newer releases and other distros this is likely unnecessary.
