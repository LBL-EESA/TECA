#ifndef teca_cf_spatial_time_step_mapper_h
#define teca_cf_spatial_time_step_mapper_h
...
class teca_cf_spatial_time_step_mapper;
using p_teca_cf_spatial_time_step_mapper = std::shared_ptr<teca_cf_spatial_time_step_mapper>;

/// NetCDF CF2 files time step mapper.
class TECA_EXPORT teca_cf_spatial_time_step_mapper : public teca_cf_time_step_mapper
{
public:

    /// allocate and return a new object
    static p_teca_cf_spatial_time_step_mapper New()
    { return p_teca_cf_spatial_time_step_mapper(new teca_cf_spatial_time_step_mapper); }

    ~teca_cf_spatial_time_step_mapper() {}
...
protected:
    teca_cf_spatial_time_step_mapper() : file_steps()
    {}

    // remove these for convenience
    teca_cf_spatial_time_step_mapper(const teca_cf_spatial_time_step_mapper&) = delete;
    teca_cf_spatial_time_step_mapper(const teca_cf_spatial_time_step_mapper&&) = delete;
    void operator=(const teca_cf_spatial_time_step_mapper&) = delete;
    void operator=(const teca_cf_spatial_time_step_mapper&&) = delete;
